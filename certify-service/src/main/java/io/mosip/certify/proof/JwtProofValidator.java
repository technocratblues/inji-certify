...
public class JwtProofValidator implements ProofValidator {
    ...
    public boolean validate(String clientId, String cNonce, String proofJwt, Map<String, Object> proofConfiguration) {
        ...
        try {
            ...
            // proofConfiguration (backed by credential_config.proof_types_supported) is nullable;
            // treat a missing/null config the same as "jwt" not being supported for this credential.
